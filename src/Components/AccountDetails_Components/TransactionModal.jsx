  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-[#27272A]  w-full sm:max-w-md rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-300 animate-in slide-in-from-bottom sm:slide-in-from-bottom-0 sm:zoom-in-95">
        ...
        <div className="flex items-center justify-between p-6 bg-[#75CB62]  dark:bg-[#27272A]">
          <div className="flex items-center  gap-2.5">
            <div
              className={`w-2 h-2 rounded-full transition-all duration-300 ${
                type === "income" ? "bg-[#096752] scale-110" : "bg-red-400 scale-110"
              }`}
            />
        ...
        <div className="px-6 py-4 flex flex-col gap-4 pb-8 sm:pb-6 dark:bg-[#2D2E32]  ">
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button onClick={handleSubmit} className="flex-1 py-3 rounded-xl bg-[#74CD63] text-sm font-semibold text-white hover:bg-[#74CD63]/90 transition-all hover:scale-[1.02] active:scale-95 dark:bg-[#27272A]  dark:text-gray-300 dark:hover:bg-[#27272A]/90 dark:border border-gray-700">
