  ...
  return (
        ...
        >
          ...
          >
            {isFiltered ? (
              ...
              <FaFilter className="text-[#73C960] dark:text-[#27272A]" />
            )}
          </button>
        </div>
      </div>
    ...
    "
            >
              <div>
                ...
                ${
                  tempFilters.dateType === type
                    ? "bg-[#73C960] dark:bg-[#E5E7EB] text-white dark:text-black shadow"
              ...
              ${
                isActive
                  // ? "bg-[#73C960] dark:bg-[#27272A] text-white shadow-md scale-105"
              ...
              <div>
                ...
                ${
                  tempFilters.transactionType === type
                    // ? "bg-[#73C960] dark:bg-[#27272A] text-white shadow"
                    // : "bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600"
                     ? "bg-[#73C960] dark:bg-[#E5E7EB] text-white dark:text-black shadow"
                    : "bg-gray-100 dark:bg-[#27272A] hover:bg-gray-200 dark:hover:bg-[#828284] dark:text-white"
                }`}
            ...
            transition"
                ...
                <button
                  onClick={handleApply}
                  className="w-full sm:w-auto px-4 py-2 rounded-lg
            bg-[#73C960] dark:bg-[#27272A] text-white
