...
export default function ThemeToggle() {
  ...
  return (
    <label className="relative inline-flex items-center cursor-pointer">
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-8 h-8 bg-[#71CA60] dark:bg-zinc-800 rounded-full shadow-lg flex items-center justify-center transition-all duration-300 ease-in-out peer-checked:left-[calc(100%-2rem)] peer-active:scale-95">
