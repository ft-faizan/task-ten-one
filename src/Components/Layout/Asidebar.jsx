...
function Asidebar() {
  ...
  return (
    <div className="w-full h-full flex flex-col item-center justify-center md:justify-start gap-6 md:gap-8 bg-[#6EC967] md:backdrop-blur-3xl md:dark:bg-zinc-800/30 dark:bg-[#858586] md:bg-[#d0edc191]  rounded-md">
      <div className="flex items-center hidden md:flex p-1   ">
        ...
        <h1 className="text-xl md:text-2xl font-semibold tracking-[-0.04em] text-[black] dark:text-white  absolute left-15 md:left-17">
          Track<span className="text-[#73CC62] dark:text-[#27272A]">.</span>
        </h1>
      </div>
