  ...
  return (
    ...
    >
      <div className="flex items-center md:justify-center gap-4  w-full justify-baseline md:w-[auto]">
        <div
          className="w-12 h-12 rounded-xl bg-[#DAEBD3] dark:bg-[#838384]
                      flex items-center justify-center
                      font-semibold text-[#74CA61] dark:text-[#242A45]"
        >
      ...
      {openMenu && (
        ...
        >
          <button
            ...
            className="block w-full text-left px-4 py-2  rounded-lg hover:bg-[#70CB68] hover:text-white  dark:hover:bg-[#5D5D62] cursor-pointer"
          >
            <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="block w-full text-left px-4 py-2  rounded-xl hover:bg-[#70CB68] hover:text-white dark:hover:bg-[#5D5D62]  cursor-pointer"
          >
            {account.isPinned ? (
              <>
                <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="flex items-center gap-2 w-full text-left px-4 py-2 rounded-xl hover:bg-[#70CB68] hover:text-white dark:hover:bg-[#5D5D62]  cursor-pointer"
          >
            {account.isArchived ? (
              <>
