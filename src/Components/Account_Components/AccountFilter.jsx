    ...
    <div className="relative">
      ...
      >
        {isFiltered ? (
          ...
          <FaFilter className="text-[#74CA61] dark:text-[#27272A]" />
        )}
      </button>
      ...
      {!isFiltered && filterOpen && (
        <div className="absolute right-0 mt-2 bg-white dark:bg-[#2D2E32]   shadow-md w-48 z-50  rounded-lg border-gray-200 border dark:border-gray-700 ">
          ...
          <button
            ...
            className="block w-full text-left px-4 py-2 hover:bg-[#74CA61] dark:hover:bg-[#5D5D62] hover:text-white rounded-lg cursor-pointer "
          >
          ...
          <button
            ...
            className="block w-full text-left px-4 py-2 hover:bg-[#74CA61] hover:text-white rounded-lg cursor-pointer dark:hover:bg-[#5D5D62] "
          >
            <div className="flex items-center gap-1">
