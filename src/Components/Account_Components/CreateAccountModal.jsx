  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm 
      ...
      <div className="bg-white dark:bg-[#2D2E32] 
                ...
                animate-slideUp">
        <div className="bg-[#73C960] dark:bg-[#27272A] px-6 py-4">
          <h2 className="text-xl font-semibold text-white">
            {editingAccount ? "Edit Account" : "Create New Account"}
          </h2>
          <p className="text-[#0b0c0b] dark:text-[#c0c0ce] text-sm mt-1">
            {editingAccount
        ...
        <div className="p-6">
          ...
          <div className="space-y-4 mb-5">
            <div className="flex items-center justify-between p-3 bg-[#70cb6880] dark:bg-[#707075] rounded-lg   ">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-[#DAEBD3] dark:bg-[#E5E7EB] rounded-full flex items-center justify-center">
                   <VscFolderActive size={20} className="text-[#70C867] dark:text-[#838384]" />
                </div>
                <div>
            ...
            <div className="flex items-center justify-between p-3 bg-[#70cb6880] dark:bg-[#707075] rounded-lg">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-[#E4F5DD] dark:bg-[#E5E7EB] rounded-full flex items-center justify-center">
                  <TiPin size={20} className="text-[#70C867] dark:text-[#838384]" />
                </div>
                <div>
                  <p className="font-medium text-gray-700 dark:text-white">
                    Pin
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-end">
            ...
            <button
              ...
              className="px-6 py-3 bg-[#70C867] dark:bg-[#27272A] text-white rounded-lg hover:from-blue-700 hover:to-blue-800 focus:ring-4 focus:ring-blue-300 transition-all duration-200 font-medium order-1 sm:order-2 border"
            >
              {editingAccount ? (
