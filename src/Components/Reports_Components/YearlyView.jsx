  ...
  return (
    <div className="space-y-5 pt-4">
      ...
      <div className="flex items-center justify-end gap-3 pr-[20px]">
        ...
        <div className="flex items-center gap-1 bg-[#D9EAD3] dark:bg-[#3D3D3E]
          border border-white/10 rounded-xl px-1 py-1">
          <button
            onClick={() => setSelectedYear((y) => Number(y) - 1)}
            className="w-7 h-7 flex items-center justify-center rounded-lg
              text-gray-500 dark:text-gray-400
              hover:bg-[#71CA60] hover:text-white transition-all duration-150 active:scale-95"
          >
      ...
      <div className="rounded-2xl overflow-hidden  border border-[#E1E3F4] dark:border-gray-600
        ...
        <div className="grid grid-cols-4 gap-1 px-3 sm:px-4 py-2.5
          bg-[#E0F1D9] dark:bg-[#3D3D3E] border-b border-white/10">
              ...
              >
                <div className="flex items-center gap-2">
                  <span className={`w-7 h-7 rounded-lg shrink-0
                    ...
                    ${isThisMonth
                      ? "bg-[#6FCA68] text-white shadow-sm shadow-[#3041DC]/30"
                      : "bg-[#E0F1DA] dark:bg-[#3D3D3E] text-[#6FCA68] dark:text-[#A7ACDD]"
                    }`}>
                    {month.slice(0, 1)}
                  </span>
                  <div className="flex flex-col min-w-0">
                    ...
                    {isThisMonth && (
                      <span className="text-[9px] text-[#6FCA68] dark:text-[#A7ACDD] font-semibold hidden sm:inline">
                        Current
                      </span>
                    )}
                  </div>
        ...
        <div className="grid grid-cols-4 gap-1 px-3 sm:px-4 py-3
          bg-[#ECF6E9] dark:bg-[#3D3D3E]/60 border-t border-white/10 text-center first:text-left">
