  ...
  return (
    <div className="space-y-5 pt-3 h-full ">
      ...
      <div className="grid md:grid-cols-2 gap-4 h-auto min-h-[58vh]">
        <div
          className="rounded-2xl border  border border-[#e6f4e1] dark:border-gray-600
          bg-[#DBECD5] dark:bg-white/[0.03] backdrop-blur-sm p-4 space-y-4"
        >
          <div
            className="flex gap-2 bg-white dark:bg-[#3D3D3E]
          ...
          {pieData.length === 0 ? (
            <div className="flex flex-col items-center justify-center gap-3 py-12">
              <div
                className="w-12 h-12 rounded-2xl bg-[#e5f5e1] dark:bg-[#3D3D3E]
        ...
        <div
          ...
          bg-[#DBECD5] dark:bg-white/[0.03] backdrop-blur-sm p-4 sm:p-5
          flex flex-col gap-5"
        >
          ...
          <div className="border-t border-[#E2FCF0] dark:border-white/10" />
