...
const balance = totalIncome - totalExpense;
  ...
  <button
    ...
    className="w-9 h-9 flex items-center justify-center rounded-xl
      bg-[#DEEFD7] dark:bg-[#3D3D3E] border border-white/10
      text-gray-600 dark:text-gray-300
      hover:bg-[#6FCA68] hover:text-white dark:hover:bg-[#27272A]
  ...
  <h2 className="font-semibold text-sm sm:text-base md:text-lg text-gray-800 dark:text-white tracking-wide select-none">
    ...
    <span className="text-[#6FCA68] dark:text-[#DEEFD7]">{selectedYear}</span>
  </h2>
