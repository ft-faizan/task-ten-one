    ...
    calendarCells.push(
      <div
        ...
        className={`relative rounded-xl p-1.5 sm:p-2 min-h-[64px] sm:min-h-[80px] md:min-h-[90px]
          ...
          border
          ${isToday
            ? "bg-[#6FCA68]/10 dark:bg-[#6FCA68]/20 border-[#6FCA68]/40 shadow-sm shadow-[#6FCA68]/10"
            : hasData
            ? "bg-[#D0EDC1] border-gray-200 hover:bg-gray-100 dark:bg-white/5 dark:border-white/20 dark:hover:bg-white/10"
            : "bg-[#DBECD4] border-gray-100 dark:bg-white/[0.03] dark:border-white/10"
          }`}
      >
        <div className="flex items-center justify-between mb-1">
          <span
            className={`text-xs sm:text-sm font-semibold w-6 h-6 flex items-center justify-center rounded-lg
              ${isToday
                ? "bg-[#6FCA68] text-white shadow-sm"
