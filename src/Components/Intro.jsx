...
function Intro({ onComplete }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#DAEBD3] overflow-hidden">
      ...
      <div className="absolute w-[400px] h-[400px] bg-[#6FCA68] blur-3xl rounded-full animate-pulse" />
      ...
      >
        ...
        <div className="absolute inset-0 blur-2xl bg-white rounded-2xl scale-125 opacity-70" />
