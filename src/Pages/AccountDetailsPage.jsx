    ...
    >
      ...
      <div className=" w-full h-[10%]  ">
        <table className="w-full h-full  p-1 mt-1 md:mt-0">
          <thead className="bg-[#DEEFD7] dark:bg-[#3D3D3E]  ">
            <tr className=" border-gray-200">
              ...
              >
                <div className="flex items-center gap-2">
                  <span>Date</span>
                  {sortConfig.key === "date" && (
                    <span className="text-[#73C960] dark:text-[#E5E7EB]">
              ...
              <table className="w-full table-fixed">
                <tbody>
                  {paginatedTransactions.map((transaction) => (
                    <tr
                      key={transaction.id}
                      className=" hover:bg-[#DEEFD7] dark:hover:bg-[#3D3D3E] transition-colors duration-150 cursor-pointer "
                    >
            ...
            {Array.from({ length: totalPages }, (_, i) => (
              <button
                ...
                className={`px-3 py-1 rounded-lg  ${
                  currentPage === i + 1
                    ? "bg-[#73C960] text-white dark:bg-[#27272A] "
